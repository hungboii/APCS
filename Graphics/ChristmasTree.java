    ...
    public static void main (String[] args)
    {
        ...
        while(i > 0)
        {
            ...
            if(i % 500 == 0)
            {
                ...
                top.addPoint(125, 225);
                top.addPoint(275, 225);
                g.fillPolygon(top);

                Polygon mid = new Polygon();
                mid.addPoint(145, 225);
                mid.addPoint(255, 225);
                mid.addPoint(300, 300);
                mid.addPoint(100, 300);
                g.fillPolygon(mid);

                Polygon bot = new Polygon();
                bot.addPoint(120, 300);
                bot.addPoint(280, 300);
                bot.addPoint(325, 375);
                bot.addPoint(75, 375);
                g.fillPolygon(bot);
                ...
                int[] x2 = {200, 215, 210, 225, 205, 200, 195, 175, 190, 185};
                int[] y2 = {95, 105, 90, 80, 80, 64, 80, 80, 90, 105};
                g.fillPolygon(x2, y2, 10); //star on top
            }
